...
def main():
    ...
    #streamlit app
    title = ' <h2 style="color: white; text-align: center;background-color:black">CodeRefactorAI</h2>'
    subtitle = ' <h4 style="color: white; text-align: center;background-color:black">A chatGPT powered code refactor application for C# Language</h4>'
